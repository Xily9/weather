...
public class ForecastAdapter extends BaseAdapter<ForecastAdapter.ViewHolder, WeatherBean.ValueBean.WeathersBean> {

    private Map<String, Integer> map = WeatherUtil.getWeatherIcons();

    public ForecastAdapter(List<WeatherBean.ValueBean.WeathersBean> mList) {
        super(mList);
    }

    @Override
    protected void onBindViewHolder(@NonNull ViewHolder holder, int position, WeatherBean.ValueBean.WeathersBean value) {
